 ...
 * @method static \Illuminate\Database\Eloquent\Builder|User whereMilitary($value)
 * @method static \Illuminate\Database\Eloquent\Builder|User whereNationalityCode($value)
